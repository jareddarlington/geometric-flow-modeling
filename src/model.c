...
// {
//     Model *model = malloc(sizeof(Model));        // allocate memory
//     model->mesh = mesh;                          // set mesh
//     glm_vec3_copy((0, 0, -10), model->position); // set position
//     glm_vec3_copy((0, 0, 0), model->rotation);   // set rotation
...
//     mesh->vertCount = dArray->size / STRIDE;
...
//         // Velocity
//         glGenBuffers(1, &(mesh->velVBO));
//         glBindBuffer(GL_ARRAY_BUFFER, mesh->velVBO);
